...
public final class Main {
	...
	public static void main(String[] args) {
		try {
			String options[] = { "config:", "help", "log:", "resign:", "srand:", "version" };
			...
			if (opt.contains("version")) {
				System.out.println("gogui-dummy 1");
				return;
			}
			...
			GeneticDummy dummy = new GeneticDummy(log, useRandomSeed, randomSeed, resign);
