...
/**
 * Dummy Go program for testing GTP controlling programs. See the gogui-dummy
 * documentation for information about the extension commands.
 */
public class GeneticDummy extends GtpEngine {

	private Board board = new Board(9);
	private Bridge bridge = null;
	private boolean pass = false;
	
	public GeneticDummy(PrintStream log, boolean useRandomSeed, long randomSeed, int resign) throws Exception {
		super(log);
		registerCommands();
		setName("gogui-dummy");
		setVersion("1");
	...
	public void cmdLiveGfx(GtpCommand cmd) throws GtpError {
		...
		sleep(1000);
		System.err.println(
				"gogui-gfx: INFLUENCE a7 -1 b7 -0.75 c7 " + "-0.5 d7 -0.25 e7 0 f7 0.25 g7 0.5 h7 0.75 " + "j7 1");
		sleep(1000);
	...
	public void cmdPlay(GtpCommand cmd) throws GtpError {
		...
		if(cmd.getPointArg(1, m_size) == null) {
