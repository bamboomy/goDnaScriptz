...
private double fd0 = 566.04332850715;
private double fd1 = 737.6466739688657;
...
if(fo0 != null){
    ...
    fb0 = !fb1;
    ab1 = fd1 < fd0;
    Thought lo0 = Thought151.getInstance(fo1, fo0, fo1, fo0, fd1, fd0, fd1, fd0, ab2, ab3, ab4, fb0);
    fd1 *= -1;
    fd0 *= -1;
    fd1 *= -1;
    fd0 = fd1 + fd0;
...
if(fo1 != null){
    ...
    fb1 = fd1 < ad1;
    double ld0 = 429.2448389272623;
    double ld1 = 838.1559896981644;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, ab1, ab2, ab3, ab4);
}
    double ld2 = 627.1619319615623;
    if (fb0) {
        fb1 = ld1 < ld2;
        double ld3 = 516.5756426605963;
if(fo1 != null){
...
if(ao4 != null){
          lb1 = ao4.m2(fo0, fo1, ao1, ao2, fd0, fd1, fd0, fd1, fb0, fb1, lb0, lb1);
}
        fb0 = fb1 || lb0;
        lb1 = !fb0;
        } else if (fb1) {
...
if(ao2 != null){
    ...
    boolean lb0 = false;
    Thought lo1 = Thought85.getInstance(ao3, ao4, fo0, fo1, ad2, ad3, ad4, fd0);
        Thought lo2 = Thought111.getInstance();
if(ao2 != null){
      ao1 = ao2.m4(lb0, fb0, fb1, lb0);
}
    Thought lo3 = Thought132.getInstance(ao3, ao4, fo0, fo1, fd1, ad1, ad2, ad3, fb0, fb1, lb0, fb0);
if(ao2 != null){
...
if(ao1 != null){
    ...
    boolean lb1 = true;
    fd1 *= -1;
    Thought lo2 = Thought259.getInstance(fo1, ao1, ao2, ao3);
...
if(ao3 != null){
    ...
    double ld0 = 382.0272012428925;
    double ld1 = 500.900024211574;
    ab4 = !fb0;
    fb1 = ab1 && ab2;
...
try {
if (false) { throw new CountDownExc(-1); }
    Thought lo0 = Thought230.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, fd0, fd1);
    double ld1 = 417.1549027561354;
...
if(fo1 != null){
    ...
    if (ab4) {
if(fo0 != null){
          fo0.m1(fo1, fo0, fo1, fo0, ld1, fd0, fd1, ld1, fb0, fb1, lb3, ab1);
}
        ab2 = !ab3;
        double ld4 = 667.6921510487891;
        ld1 = fd0 + fd1;
if(fo1 != null){
          fo1.m2(ld4, ld1, fd0, fd1, ab4, fb0, fb1, lb3);
}
...
if(fo1 != null){
    ...
    Thought lo4 = Thought100.getInstance(ad2, ad3, ad4, fd0);
    lb2 = lb3 && ab1;
...
if(ao1 != null){
    ...
    fb1 = fd0 > fd1;
if(ao2 != null){
      ao2.m2(ao3, ao4, fo0, fo1, fd0, fd1, fd0, fd1, lb1, fb0, fb1, lb1);
}
if(ao1 != null){
      fd0 = ao1.m3(fd1, fd0, fd1, fd0, fb0, fb1, lb1, fb0);
}
    Thought lo2 = Thought181.getInstance(ao2, ao3, ao4, fo0, fb1, lb1, fb0, fb1);
if(ao1 != null){
...
if(fo1 != null){
    ...
    fb0 = fb1 && lb1;
    double ld3 = 343.82444761279305;
    fb0 = fb1 && lb1;
    boolean lb4 = false;
    double ld5 = 208.69055926791282;
    lb4 = fb0 || fb1;
    ld3 = ld5 - fd0;
if(ao2 != null){
      ao1 = ao2.m4(ao3, ao4, fo0, fo1, fd1, ld3, ld5, fd0);
}
    lb1 = lb4 && fb0;
    boolean lb6 = true;
    fd1 = ld3 - ld5;
...
if(ao2 != null){
    ...
    ad2 = ad3 - ad4;
    double ld2 = 348.5530406135443;
if(ao3 != null){
              ao3.m2(fb1, lb0, lb1, fb0);
}
    boolean lb3 = false;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, ad4, fd0, fd1, ld2, fb0, fb1, lb0, lb1);
}
    lb3 = ad1 < ad2;
    Output.points[3][8] -= ad3;
    Thought lo4 = Thought2.getInstance(ad4, fd0, fd1, ld2, fb0, fb1, lb0, lb1);
    ad1 = ad2 - ad3;
    Output.points[4][0] -= ad4;
    lb3 = fd0 < fd1;
    fb0 = ld2 > ad1;
if(ao4 != null){
      fb1 = ao4.m2(fo0, fo1, ao1, ao2, lb0, lb1, lb3, fb0);
}
    fb1 = lb0 || lb1;
if(ao3 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd1 = fd0 + fd1;
    boolean lb0 = true;
    double ld1 = 621.9754520680477;
if(ao1 != null){
      fb0 = ao1.m2(ao2, ao3, ao4, fo0, ld1, fd0, fd1, ld1);
}
    for(int i0=0; i0<10; i0++){
        fd0 = fd1 - ld1;
        fd0 = fd1 - ld1;
...
if(ao2 != null){
      ao1 = ao2.m4(ad3, ad4, fd0, fd1, fb1, lb0, ab1, ab2);
}
if(ao4 != null){
...
if(ao3 != null){
    ...
    ab4 = fd0 > fd1;
    fb0 = fb1 || lb0;
    Thought lo2 = Thought167.getInstance(ad1, ad2, ad3, ad4);
...
if(fo0 != null){
    ...
    Thought lo1 = Thought241.getInstance(fo1, fo0, fo1, fo0, fd0, fd1, fd0, fd1, fb0, fb1, lb0, ab1);
    Thought lo2 = Thought7.getInstance(fd0, fd1, fd0, fd1, ab2, ab3, ab4, fb0);
...
if(fo1 != null){
    ...
    Thought lo1 = Thought142.getInstance(lb0, fb0, fb1, lb0);
    Thought lo2 = Thought396.getInstance(fo0, fo1, fo0, fo1, ad4, fd0, fd1, ad1, fb0, fb1, lb0, fb0);
    Thought lo3 = Thought99.getInstance(ad2, ad3, ad4, fd0, fb1, lb0, fb0, fb1);
    double ld4 = 54.85075857887678;
    Output.points[4][7] += fd0;
    lb0 = fb0 || fb1;
    double ld5 = 863.0607582291415;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, lb0, fb0, fb1, lb0);
}
    boolean lb6 = true;
    lb6 = fd0 > fd1;
    Thought lo7 = Thought230.getInstance(fo0, fo1, fo0, fo1);
    double ld8 = 499.64671337249155;
    double ld9 = 379.0608938476566;
...
if (false) { throw new CountDownExc(-1); }
    boolean lb0 = true;
    double ld1 = 162.58121052074765;
    lb0 = !ab1;
    Thought lo2 = Thought220.getInstance(ad1, ad2, ad3, ad4);
    Thought lo3 = Thought301.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, ld1, ad1);
    ab2 = !ab3;
    ab4 = ad2 > ad3;
...
if(fo1 != null){
    ...
    ab2 = ab3 || ab4;
    boolean lb5 = false;
    Thought lo6 = Thought212.getInstance(fo0, fo1, fo0, fo1, ad4, fd0, fd1, ld1, ab4, fb0, fb1, lb0);
    boolean lb7 = false;
    lb5 = !lb7;
if(fo0 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fb1 = !fb0;
    boolean lb0 = true;
    Thought lo1 = Thought257.getInstance(ao2, ao3, ao4, fo0, fd0, fd1, fd0, fd1, fb0, fb1, lb0, fb0);
    for(int i0=0; i0<10; i0++){
        Thought lo2 = Thought392.getInstance(fd0, fd1, fd0, fd1, fb1, lb0, fb0, fb1);
if(fo1 != null){
...
if(ao2 != null){
      ad1 = ao2.m3(fb0, fb1, lb0, fb0);
}
if(ao4 != null){
      ao3 = ao4.m4(fo0, fo1, ao1, ao2, ad2, ad3, ad4, fd0, fb1, lb0, fb0, fb1);
}
    if (lb0) {
        ...
        fb0 = ad4 < fd0;
if(ao3 != null){
          ao3.m3(fd1, ad1, ad2, ad3, fb1, lb0, fb0, fb1);
}
if(fo0 != null){
...
if(fo0 != null){
        ...
        Thought lo1 = Thought65.getInstance(fo1, ao1, ao2, ao3, ad1, ad2, ad3, ad4);
...
if(ao3 != null){
    ...
    Thought lo0 = Thought295.getInstance(fd1, fd0, fd1, fd0, fb0, fb1, ab1, ab2);
if(ao2 != null){
...
if(ao1 != null){
        ...
        boolean lb4 = false;
if(ao2 != null){
          ao2.m2(ao3, ao4, fo0, fo1, fd1, ld3, ld1, fd0);
}
if(ao2 != null){
          ao1 = ao2.m4();
}
...
try {
if (false) { throw new CountDownExc(-1); }
    double ld0 = 407.7683449973589;
    Thought lo1 = Thought13.getInstance(ab2, ab3, ab4, fb0);
    boolean lb2 = false;
    fb0 = ad1 < ad2;
    Thought lo3 = Thought261.getInstance(ao1, ao2, ao3, ao4, ad3, ad4, fd0, fd1, fb1, lb2, ab1, ab2);
if(fo0 != null){
      ld0 = fo0.m3(ad1, ad2, ad3, ad4, ab3, ab4, fb0, fb1);
}
if(fo1 != null){
      fo1.m2(ao1, ao2, ao3, ao4, lb2, ab1, ab2, ab3);
}
    ab4 = fd0 < fd1;
    fb0 = ld0 > ad1;
    ad2 *= -1;
...
if(ao3 != null){
    ...
    ab4 = ad2 > ad3;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, ad4, fd0, fd1, ld0, fb0, fb1, lb2, ab1);
}
...
if (false) { throw new CountDownExc(-1); }
    fb0 = fb1 || fb0;
    Thought lo0 = Thought120.getInstance(fd0, fd1, fd0, fd1, fb1, fb0, fb1, fb0);
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, fb1, fb0, fb1, fb0);
}
    fd0 = fd1 - fd0;
    Thought lo1 = Thought238.getInstance(fo1, fo0, fo1, fo0);
    fb1 = fb0 && fb1;
    Output.points[5][2] -= fd1;
    fb0 = fb1 && fb0;
    Thought lo2 = Thought271.getInstance(fd0, fd1, fd0, fd1);
    boolean lb3 = true;
if(fo1 != null){
...
if(fo0 != null){
      lb4 = fo0.m2(fo1, fo0, fo1, fo0, fd0, fd1, fd0, fd1, fb0, fb1, lb3, lb4);
}
...
if(fo1 != null){
    ...
    double ld0 = 656.6396222953992;
if(fo0 != null){
      fo0.m1(fo1, fo0, fo1, fo0, ab2, ab3, ab4, fb0);
}
    fd0 = fd1 + ld0;
    if (fb1) {
        Thought lo1 = Thought275.getInstance(fo1, fo0, fo1, fo0);
        fd0 *= -1;
        boolean lb2 = true;
        fd1 = ld0 + fd0;
        lb2 = !ab1;
        Thought lo3 = Thought265.getInstance(fd1, ld0, fd0, fd1);
        ld0 = fd0 + fd1;
        boolean lb4 = false;
if(fo0 != null){
        ...
        boolean lb5 = false;
        double ld6 = 322.7884105665353;
        } else {
        Thought lo7 = Thought113.getInstance();
}
Thought.STACK_COUNTER++;
return fo1;
} catch (StackOverflowExc | NoClassDefFoundError e) { throw new CountDownExc(50);
...
if(fo1 != null){
    ...
    fb0 = fb1 && lb0;
if(fo0 != null){
      fb0 = fo0.m2(fo1, fo0, fo1, fo0, ad2, ad3, ad4, fd0, fb1, lb0, fb0, fb1);
}
if(fo1 != null){
      lb0 = fo1.m2(fd1, ad1, ad2, ad3, fb0, fb1, lb0, fb0);
}
    ad4 = fd0 - fd1;
    double ld1 = 633.3493772929751;
if(fo1 != null){
...
if(fo1 != null){
        ...
        double ld2 = 415.4051287646059;
        lb0 = ad3 < ad4;
if(fo0 != null){
          fo0.m2(fo1, fo0, fo1, fo0, fd0, fd1, ld2, ld1);
}
        Thought lo3 = Thought359.getInstance();
        Thought lo4 = Thought168.getInstance(fb0, fb1, lb0, fb0);
        fb1 = lb0 || fb0;
}
Thought.STACK_COUNTER++;
return fo1;
...
if (false) { throw new CountDownExc(-1); }
    ab1 = ab2 && ab3;
    Thought lo0 = Thought241.getInstance(fo0, fo1, fo0, fo1, ad1, ad2, ad3, ad4, ab4, fb0, fb1, ab1);
    fd0 = fd1 + ad1;
    ad2 = ad3 - ad4;
    Thought lo1 = Thought40.getInstance(fd0, fd1, ad1, ad2, ab2, ab3, ab4, fb0);
if(fo1 != null){
...
if(fo0 != null){
    ...
    Thought lo2 = Thought200.getInstance(fo1, fo0, fo1, fo0, ad1, ad2, ad3, ad4);
    Thought lo3 = Thought292.getInstance();
    ab1 = ab2 || ab3;
...
if(ao2 != null){
      ao2.m3(ao3, ao4, fo0, fo1, fd0, fd1, fd0, fd1, lb0, fb0, fb1, lb0);
}
if(ao1 != null){
      fb0 = ao1.m2(fd0, fd1, fd0, fd1, fb1, lb0, fb0, fb1);
}
    fd0 = fd1 - fd0;
    fd1 = fd0 + fd1;
    lb0 = fd0 < fd1;
...
if(ao2 != null){
    ...
    fb0 = fb1 && fb0;
    Thought lo0 = Thought320.getInstance(fb1, fb0, fb1, fb0);
if(ao3 != null){
...
if(ao3 != null){
        ...
        boolean lb1 = false;
if(ao4 != null){
          ao4.m1(fo0, fo1, ao1, ao2, fd0, fd1, fd0, fd1, lb1, lb0, ab1, ab2);
}
        boolean lb2 = false;
if(ao3 != null){
          ao3.m2(fd0, fd1, fd0, fd1, ab2, ab3, ab4, fb0);
}
if(fo0 != null){
          ao4 = fo0.m4(fo1, ao1, ao2, ao3, fb1, lb1, lb2, lb0);
}
        double ld3 = 60.5906460207571;
        Thought lo4 = Thought242.getInstance(ao4, fo0, fo1, ao1);
if(ao3 != null){
          ao2 = ao3.m4(ld3, fd0, fd1, ld3);
}
        double ld5 = 752.9426994712277;
if(ao4 != null){
...
if(fo1 != null){
    ...
    Thought lo3 = Thought102.getInstance();
if(fo0 != null){
      fo0.m2(fb1, lb1, lb2, fb0);
}
if(fo1 != null){
      fb1 = fo1.m2(fo0, fo1, fo0, fo1, ld0, fd0, fd1, ld0, lb1, lb2, fb0, fb1);
}
if(fo1 != null){
...
if(fo1 != null){
    ...
    Thought lo1 = Thought98.getInstance(fb1, fb0, fb1, fb0);
    boolean lb2 = true;
    Thought lo3 = Thought324.getInstance(fo0, fo1, fo0, fo1, ld0, fd0, fd1, ld0, fb0, fb1, lb2, fb0);
    fb1 = fd0 < fd1;
    double ld4 = 986.7910937543664;
    boolean lb5 = true;
    Thought lo6 = Thought138.getInstance(ld0, ld4, fd0, fd1, lb2, lb5, fb0, fb1);
    lb2 = !lb5;
if(fo1 != null){
